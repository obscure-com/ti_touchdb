...
(function() {
  ...
  // normally, you would probably want to do this after the UI is up and running
  // or during some splash animation
  books.initialize(function(err, data) {
    Ti.App.fireEvent('books:replication_complete', data);
  });
